...
export const Timeline = ({ data, tripData }: { data: TimelineEntry[], tripData: TripInfo }) => {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto pt-7 px-4 md:px-8 lg:px-10">
        ...
        <div className="flex gap-6 md:gap-10 text-sm md:text-base text-gray-500 mb-10">
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-10">
        {data.map((item, index) => (
          <div
            key={index}
            className="flex justify-start pt-10 md:pt-10 md:gap-4"
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-[40%]">
              ...
              <h3 className="hidden md:block text-xl md:pl-15 md:text-1xl font-bold text-neutral-500 dark:text-neutral-500 ">
                {item.title}
              </h3>
            </div>

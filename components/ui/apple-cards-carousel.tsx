  ...
  return (
    <>
        ...
        {open && (
          <div className="fixed inset-0 z-50 h-screen overflow-auto">
            ...
            <motion.div
              ...
              className="relative z-[60] mx-2 sm:mx-4 md:mx-auto my-4 sm:my-6 md:my-10 h-fit max-w-5xl rounded-xl sm:rounded-2xl md:rounded-3xl bg-white p-3 sm:p-4 md:p-6 lg:p-10 font-sans dark:bg-neutral-900"
            >
              <button
              ...
              <motion.p
                ...
                className="mt-2 sm:mt-4 text-xl sm:text-2xl md:text-3xl lg:text-5xl font-semibold text-neutral-700 dark:text-white"
              >
                {card.title}
              </motion.p>
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className="relative z-10 flex h-60 sm:h-80 w-44 sm:w-56 flex-col items-start justify-start overflow-hidden rounded-3xl bg-gray-100 md:h-[30rem] lg:h-[40rem] md:w-80 lg:w-96 dark:bg-neutral-900"
      >
        ...
        <div className="relative z-40 p-4 sm:p-6 md:p-8">
          ...
          <motion.p
            layoutId={layout ? `title-${card.title}` : undefined}
            className="mt-1 sm:mt-2 max-w-xs text-left font-sans text-sm sm:text-lg md:text-xl lg:text-3xl font-semibold [text-wrap:balance] text-white"
          >
            {card.title}
          </motion.p>
        </div>
